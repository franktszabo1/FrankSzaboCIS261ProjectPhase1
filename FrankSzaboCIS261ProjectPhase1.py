...
def GetHoursWorked():
    hoursworked = input(float("Enter Hours Worked: "))
    return hoursworked
#write the GetHourlyRate function
def GetHourlyRate():
    hourlyrate = input(float("Enter Hours Worked: "))
# write the GetTaxRate function
def GetTaxRate():
    taxrate = input(float("Enter Tax Rate: "))
...
def PrintTotals(TotEmployees, TotHours, TotGrossPay, TotTax, TotNetPay):    
    ...
    print (TotGrossPay, TotTax, TotNetpay)
